...
class View:
    ...
    def create_new_message(self, sender, recipient, message):
    ...
    def userUI(self):
        ...
        while True:
            ...
            if (n == '1'):
                ...
                self.create_new_message(self._username, recipient, mes)
